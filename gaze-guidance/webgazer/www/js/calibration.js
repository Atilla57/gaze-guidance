  ...
  swal({
    ...
    sleep(5000).then(() => {
      ...
      swal({
        ...
        text: `- Falls der obige Accuracy-Wert über 60% liegt, dann kannst du nun auf "OK" und anschließend oben rechts auf "Spiel Starten" klicken 
        und mit dem Spielen beginnen.
        - Wenn der Accuracy-Wert schlechter ist, wiederhole bitte die Kalibration, indem du auf Recalibrate klickst und die vorherigen Schritte erneut ausführst.
        - Falls du keine bessere Accuracy auch bei dem zweiten bzw. dritten Versuch hinbekommen solltest, kannst du dann auf "Spiel Starten" klicken.`,
        allowOutsideClick: false,
        buttons: {
          cancel: "Recalibrate",
          confirm: true,
